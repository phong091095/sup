...
namespace shipping.Model
{
    public class DonViVanChuyen
    {
        ...
        [EnumDataType(typeof(TrangThaiTong.TrangThai), ErrorMessage = "Trạng thái không hợp lệ.")]
        public string TrangThai { get; set; } = default!;

        public ICollection<ChiTietDVVanChuyen> ChiTietDVVanChuyens { get; set; } = new List<ChiTietDVVanChuyen>();
    }
